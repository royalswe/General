...
exports.countries = function() {
    var countries = [
        ...
        { id: 17, gold: 2, units: 1, neighbour: [16,20,18,2] },
        ...
        { id: 22, gold: 3, units: 1, neighbour: [20,21,23,24,25] },
        { id: 23, gold: 2, units: 1, neighbour: [22,21,25] },
        { id: 24, gold: 2, units: 1, neighbour: [25,22,13,26] },
        ...
        { id: 30, gold: 2, units: 1, neighbour: [29,7,31] },
...
exports.continents = function() {
    var continents = [
        ...
        { continent: 'east-europe', gold: 7, countries: [10,11,12,13,14,15,16] },
        { continent: 'asia', gold: 5, countries: [17,18,19,20,21,22,23] },
        { continent: 'middle-east', gold: 2, countries: [24,25,26,27] },
        { continent: 'africa', gold: 3, countries: [28,29,30,31,32] }
    ]
